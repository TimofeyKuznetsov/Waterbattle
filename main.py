...
def Perimeter_multideck(a,b,c,d):
    for i in range(b):
        for j in range(d):
            game_board[players_digital_number][a+i][c+j]=2
...
for players_digital_number in range(2):
    ...
    for digital_number_of_the_ship in range(1,5):
        ...
        while 1!=0:
            ...
            if game_board[players_digital_number][the_first_cordinate][the_second_cordinate]!=1 and game_board[players_digital_number][the_first_cordinate][the_second_cordinate]!=2:
                break
#        for i in range(3):
#           for j in range(3):
            ...
            while 1!=0:
                ...
                if the_first_initial_cordinate==the_first_final_cordinate:
                    for j in range(numerical_number_of_ship_decks):
                        if the_second_final_cordinate-the_second_initial_cordinate+1==numerical_number_of_ship_decks and game_board[players_digital_number][the_first_initial_cordinate][the_second_initial_cordinate + j] != 2 and game_board[players_digital_number][the_first_initial_cordinate][the_second_initial_cordinate + j] != 1:
                            u=1
                elif the_second_initial_cordinate == the_second_final_cordinate:
                    for j in range(numerical_number_of_ship_decks):
                        if the_first_final_cordinate-the_first_initial_cordinate+1==numerical_number_of_ship_decks and game_board[players_digital_number][the_first_initial_cordinate+j][the_second_initial_cordinate]!=2 and game_board[players_digital_number][the_first_initial_cordinate+j][the_second_initial_cordinate]!=1:
                            u=1
                if u==1:
                    break
            if the_first_initial_cordinate==the_first_final_cordinate:
                ...
                for i in range(numerical_number_of_ship_decks):
                    game_board[players_digital_number][the_first_initial_cordinate][the_second_initial_cordinate+i]=1
            elif the_second_initial_cordinate==the_second_final_cordinate:
                if the_second_initial_cordinate==0:
                    if the_first_initial_cordinate==0:
