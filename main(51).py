...
def Perimeter(a,b,c,d):
    for i in range(b):
        for j in range(d):
            game_board[the_players_digital_number][the_first_cordinate-a+i][the_second_cordinate-c+j]=2
def Perimeter_multideck(a,b,c,d):
    for i in range(b):
        for j in range(d):
            game_board[the_players_digital_number][a+i][c+j]=2
    ...
    for numerical_number_of_ship_decks in range(2,5):
        for digital_number_of_the_ship in range(1,5-numerical_number_of_ship_decks+1):
            ...
            if the_first_initial_cordinate==the_first_final_cordinate:
                ...
                for i in range(numerical_number_of_ship_decks):
                    game_board[the_players_digital_number][the_first_initial_cordinate+i][the_second_initial_cordinate]=1
            print(' ',end=' ')
            for i in range(10):
                if i==9:
                    print('К')
